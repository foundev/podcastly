import { loadPodcasts, getPodcast, getEpisodesForPodcast, addPodcast, addEpisodesToPodcast, } from "./storage.js";
...
function renderPodcasts() {
    ...
    state.podcasts.forEach((podcast) => {
        ...
        const titleEl = clone.querySelector(".podcast-title");
...
function renderEpisodes(data) {
    ...
    data.episodes.forEach((episode) => {
        const clone = template.content.cloneNode(true);
        const episodeTitle = clone.querySelector(".episode-title");
        episodeTitle.textContent = episode.title;
        const episodeDesc = clone.querySelector(".episode-description");
        ...
        const episodeMeta = clone.querySelector(".episode-meta");
...
function highlightSelectedPodcast() {
    document.querySelectorAll(".podcast-button").forEach((button) => {
        ...
        htmlButton.classList.toggle("is-selected", Number(htmlButton.dataset.podcastId) === state.selectedPodcastId);
    });
}
