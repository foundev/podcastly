      ...
      <CardContent sx={{ position: "relative", zIndex: 1 }}>
        ...
        {podcasts.length === 0 ? (
          ...
          >
            ...
            <Typography variant="body2">{t.library.empty}</Typography>
          </Box>
        ) : (
          <List
                ...
                >
                  <Stack spacing={1} sx={{ width: "100%" }}>
                    ...
                    >
                      ...
                      {(() => {
                        const updated = formatUpdatedAt(podcast.updated_at);
                        if (!updated) {
                          return null;
                        }
                        return (
                          <Chip
                            label={t.library.updatedOn(updated)}
                            color={
                              podcast.id === selectedPodcastId
                                ? "secondary"
                                : "default"
